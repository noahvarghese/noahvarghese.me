        ...
        <React.Fragment>
            <div className="experienceStyle">
              ...
              <div className="projectStyle">
                <h2>Projects</h2>
                <br />
                  <h4><a className="linkStyle" href="http://www.noahvarghese.me/projects/todo/">React Todo App</a></h4>
                  <br />
                  <p>A simple todo list written using React. Was used to get familiar with React and state management.</p>  
                  <br />
                  <h4><a className="linkStyle" href="http://github.com/noahvarghese/userApi">Authentication Api</a></h4>
                  <br />
                  ...
                  <br />
                  <h4><a className="linkStyle" href="http://www.noahvarghese.me/projects/restaurant">Restaurant Generator</a></h4>
                  <br />
