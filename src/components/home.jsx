...
export const HomeComponent = () => {
    const conversant = technical_skills.filter(
        (skill) => skill.level === SkillLevel.CONVERSANT
    );
    const proficient = technical_skills.filter(
        ...
        <>
            <div id="message">
                <p>
                    ...
                    someone to jumpstart your next venture, find out more about
                    me, or looking to hire, feel free to look around!
                </p>
            </div>
            <div id="about">
                <div id="stack">
